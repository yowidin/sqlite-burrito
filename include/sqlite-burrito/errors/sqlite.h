...
SQLITE_BURRITO_EXPORT extern const std::error_category &sqlite3_error_category() noexcept;
SQLITE_BURRITO_EXPORT extern const std::error_category &sqlite3_condition_category() noexcept;

inline SQLITE_BURRITO_EXPORT std::error_code make_error_code(int error) {
   return {error, sqlite3_error_category()};
}
...
inline SQLITE_BURRITO_EXPORT std::error_condition make_error_condition(condition ec) {
...
template <>
SQLITE_BURRITO_EXPORT struct is_error_code_enum<sqlite_burrito::errors::error> : true_type {};
